...
The tf.summary calls have been updated to work with tensorflow version 0.12 and above (Thanks to @4nonymou5). To work with older versions of tensorflow use branch [tf.0.11_compatible](https://github.com/shekkizh/FCN.tensorflow/tree/tf.0.11_compatible).
